...
var main = function () {
    ...
    if (count < 10){
     ...
     if (rows===10){
      ...
      $(".tweet:eq("+rows+")").fadeOut(600, function() {
        $(".tweet:eq("+rows+")").replaceWith("<p class='tweet' style='display:none'>"+tweet.text+"</p>");
 ...
 $(".content").append("<p id='watch1' style='display:none'>Twitter analysis initiated:</p>");
 $("#watch1").slideDown(1500);
}
